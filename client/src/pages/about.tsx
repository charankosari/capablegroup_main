...
export default function About() {
  ...
  const team = [
    ...
    },
    {
      ...
      bio: "Strategic thinker who bridges the gap between business goals and technical implementation.",
    ...
    },
    {
      ...
      bio: "Frontend specialist passionate about creating beautiful, performant user interfaces.",
    ...
    },
    {
      name: "Lisa Thompson",
      role: "AI/ML Engineer",
      bio: "Machine learning expert who builds intelligent solutions that automate complex business processes.",
      image: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80",
      skills: ["Python", "TensorFlow", "OpenAI API", "Data Science"]
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <Link href="/contact">
                <Button size="lg" className="hover-lift smooth-transition" data-testid="about-hero-cta">
                  Work With Us
                </Button>
              </Link>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              ...
              >
                <Card className="h-full glass-card hover-lift smooth-transition" data-testid={`about-value-${index}`}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {team.map((member, index) => (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
              >
                <Card className="glass-card overflow-hidden hover-lift smooth-transition" data-testid={`team-member-${index}`}>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="flex gap-2">
                      <Button variant="ghost" size="icon" className="hover-lift smooth-transition" data-testid={`team-member-linkedin-${index}`}>
                        <Linkedin className="h-4 w-4" />
                      </Button>
                      <Button variant="ghost" size="icon" className="hover-lift smooth-transition" data-testid={`team-member-github-${index}`}>
      ...
      <section className="py-20 bg-muted">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h2 className="font-heading font-bold text-2xl mb-6 animate-fade-in">Our Story</h2>
            ...
            <div>
              <h2 className="font-heading font-bold text-2xl mb-6 animate-fade-in">Get In Touch</h2>
              ...
              <div className="mt-8 animate-fade-in-delay-2">
                ...
                <Link href="/contact">
                  <Button variant="outline" className="hover-lift smooth-transition" data-testid="about-careers-cta">
                    View Open Positions
                  </Button>
                </Link>
              </div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-delay-2">
            <Link href="/contact">
              <Button size="lg" className="hover-lift smooth-transition" data-testid="about-cta-contact">
                Start a Project
              </Button>
            </Link>
            <Link href="/work">
              <Button variant="outline" size="lg" className="hover-lift smooth-transition" data-testid="about-cta-work">
                View Our Work
              </Button>
            </Link>
          </div>
